...
RelayCommand fungerer således, at der laves en Command property\todo{en ordforklaring til dette afsnit ville være nice til os uden GUI.}, som View kan data binde til. Commanden ”relayer”\todo{”” antyder indforstået betydning, det kender vi andre ikke noget til.} til en metode, og når en knap der er data bindet til en command bliver trykket på, så vil den pågældende metode blive kaldt. På denne måde kan der data bindes til metoder.
